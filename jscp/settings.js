...
let settings = {
    ...
    pages: [
        ...
        //     content: 'Thank you for living and accepting me❤️' 
        // },
        ...
        //     content: 'Wish you all the best 💝💝💝 , i will always try to be better day by day for you' 
        // },

        // // Lembar 5
        // { 
        //     image: './image/photos/9.png',
        // },
        // { 
        //     image: './image/photos/b10.png', 
        //     content: 'Aku tidak mengenalmu sejak awal, tapi aku akan bersamamu sampai akhir' 
        // }
    ],
    enableBook: true,
    enableHeart: true,
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        sequence: 'HAPPY|WHITE|DAY|MY|LOVE|🤍',
        // sequence: 'HAPPY|BIRTHDAY|TO|ANITA|❤',
        sequenceColor: '#fffeff', // Màu pink mẫu
        gift: './image/happy4.gif',
        enableBook: true,
        enableHeart: true,
        isSave: false,  
